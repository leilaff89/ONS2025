...
public class WDMLink extends Link {
    ...
    public WDMLink(int id, int src, int dst, double delay, double weight, int wavelengths, int bw) {
    ...
    public int addTraffic(int wavelength, int bw) {
        //System.out.println(bw +" " + availableBandwidth[wavelength]);
    ...
    public int removeTraffic(int wavelength, int bw) {
        ...
        if (wavelength < 0 || wavelength >= this.wavelengths || bw > this.bw - availableBandwidth[wavelength]) {
            System.out.println("Teria de remover: " + bw + " > " + (this.bw - availableBandwidth[wavelength]));
            throw (new IllegalArgumentException());
        } else {            
            availableBandwidth[wavelength] += bw;            
            return availableBandwidth[wavelength];
    ...
    public void setIsInterupted(boolean isInterupted) {
        ...
        if (isIsInterupted()) {
            ...
            for (boolean b : freeWavelengths) {

                b = false;

            }
            for(int band :availableBandwidth){
